...
export const likeDog = (dog:TypeDog):TypeDogThunkAction => async(dispatch, getState) => {
...
export type TypeDogThunkAction = ThunkAction<void, TypeRootReducer, undefined, DogActions>

export type TypeDogDispatch = ThunkDispatch<TypeRootReducer, undefined, DogActions>
